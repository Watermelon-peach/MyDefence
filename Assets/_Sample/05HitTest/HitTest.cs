...
namespace Sample
{
    ...
    public class HitTest : MonoBehaviour
    {
        ...
        //충돌하면 true반환, 충돌하지 않았으면 false반환
        private bool CheckHitBox(CBox a, CBox b)
        {
            float xDistance = a.x > b.x ? (a.x - b.x) : (b.x - a.x);
            float yDistance = a.y > b.y ? (a.y - b.y) : (b.y - a.x);
        ...
        //타겟으로 이동할 때 타겟까지 남은거리가 한 프레임에 이동하는 거리보다 작을 때 충돌이라고 판정
