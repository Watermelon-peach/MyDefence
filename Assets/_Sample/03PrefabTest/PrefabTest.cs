...
namespace Sample
{
    public class PrefabTest : MonoBehaviour
    {
        ...
        {
            //[1]하나생성
            //Vector3 position = new Vector3(5f, 0, 8f);    //생성할 위치
            //Instantiate(tilePrefab, position, Quaternion.identity);

            //[2] n(10) * m(10) 생성 - 5*5 7*7
            //GenerateMap(5, 10);
            //GenerateMap2(10, 10);

            //[3] 타일을 생성 - x좌표를 0~50 사이의 랜덤값, y = 0, z좌표를 0~50사이의 랜덤 값
            /*for (int i = 0; i < 10; i++)
            {
                GenerateRandomMapTile();
            }*/

            //[4] 타일을 10개 생성, 타일 하나 생성할 때마다 딜레이 0.2초 준다
